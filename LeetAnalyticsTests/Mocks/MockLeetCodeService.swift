...
final class MockLeetCodeService: LeetCodeServiceProtocol {
    ...
    var problemsForTagResult: Result<QuestionListResponse, Error> = .success(
        QuestionListResponse(totalNum: 100, data: [])
    )
    ...
    private(set) var languageStatsCallCount = 0
    private(set) var skillStatsCallCount = 0
    private(set) var problemsForTagCallCount = 0
...
extension MockLeetCodeService {
    static func makeMatchedUser() -> MatchedUser {
        MatchedUser(
            ...
            badges: [
                UserBadge(badgeID: "7588899", name: "Annual Badge",
